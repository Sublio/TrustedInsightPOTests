...
if target == 'android'
  ...
  exec("export APP=prebuilt/TrustedInsight.app && export APP_BUNDLE_PATH=$APP && bundle exec cucumber -p ios features/edit_profile_change_company.feature #{ARGV.join(' ')}")
else
